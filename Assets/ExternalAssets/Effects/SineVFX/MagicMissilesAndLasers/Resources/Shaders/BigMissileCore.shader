...
////// Emissive:
                ...
                float2 node_743 = (i.uv0+node_136.g*float2(0,0.75)).rg;
                ...
                float2 node_8814 = (i.uv0+node_136.g*float2(0,0.5)).rg;
                ...
                half4 finalRGBA = half4(finalColor,(node_2567.g*node_5564));
                return finalRGBA;
            }
                ENDHLSL
        }
